...
- This was taken from the Boutique Ado walkthrough project, as instructed to by tutors in some parts to ensure the code ran as expected. some code was taken as a baseplate for me to 
